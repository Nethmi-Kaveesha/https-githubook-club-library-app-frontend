            ...
            <table className="min-w-full divide-y divide-teal-700">
                ...
                <tr>
                    {[
                        ...
                        <th
                            key={header}
                            scope="col"
                            className="px-6 py-3 text-left text-xs font-medium text-teal-300 uppercase tracking-wider select-none"
                        >
                            {header}
                        </th>
                    ))}
                ...
                {lendings.length === 0 ? (
                    <tr>
                        <td
                            colSpan={7}
                            className="px-6 py-4 text-center text-teal-400"
                        >
                    ...
                    lendings.map((lending) => (
                        <tr
                            key={lending._id}
                            className="hover:bg-teal-900 cursor-pointer"
                        >
